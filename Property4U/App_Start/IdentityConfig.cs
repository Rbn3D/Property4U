...
namespace IdentitySample.Models
{
    ...
    // Modified ApplicationRoleManager Class "IdentityRole" with our Custom "ApplicationRole" - P4U
    ...
    public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext> 
    {
        ...
        public static void InitializeIdentityForEF(ApplicationDbContext db) {
            ...
            if (user == null) {
                user = new ApplicationUser { UserName = name, Email = name, FirstName = firstName, LastName = lastName, Address = address, City = city, State = state, PostalCode = postalCode };
